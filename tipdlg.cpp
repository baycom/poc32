...
:CDialog (IDD_TIP, pParent)
{
  ...
  if ((GetUserDefaultLCID () & 0xff) != 0x07)
    m_pStream = fopen ("tipseng.txt", "r");
  else
    m_pStream = fopen ("tipsde.txt", "r");
...
BEGIN_MESSAGE_MAP (CTipDlg, CDialog)
  //{{AFX_MSG_MAP(CTipDlg)
  ON_BN_CLICKED (IDC_NEXTTIP, OnNextTip) ON_WM_CTLCOLOR ()ON_WM_PAINT ()
  //}}AFX_MSG_MAP
  END_MESSAGE_MAP ()
/////////////////////////////////////////////////////////////////////////////
